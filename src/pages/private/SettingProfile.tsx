...
function checkIsImageValid() {
  let previewImage = document.getElementById("selectedImage") as HTMLImageElement;
  let formInputImage = document.getElementById("formInputImage") as HTMLInputElement;
  ...
  if (file) {
    ...
    newImage.onload = function () {
      ...
      if (size > 10)
        errorsSpan.innerText = "image has more than 10MB";
      if (newImage.width > 400 || newImage.height > 800)
        errorsSpan.innerText = "image dimentions not accepted, please retry with an other one ";
      if (errorsSpan.innerText !== "")
      {
        formInputImage.value = "";
        previewImage.src = "";
        !previewImage.classList.contains("d-none") && previewImage.classList.add("d-none");
        errorsSpan.classList.contains("d-none") && errorsSpan.classList.remove("d-none");
      }
      else
      {
        previewImage.classList.contains("d-none") && previewImage.classList.remove("d-none");
        !errorsSpan.classList.contains("d-none") && errorsSpan.classList.add("d-none");
      ...
      >
        ...
        <div className="enable2F-container">
          <div className="enable2F">
            <label htmlFor="enable2F">Two factor Authentication</label>
