    ...
    <>
      <div className={`bg-successs d-flex flex-column ${gameProfileInGame}`} >
          ...
          <div className="bg-infoo col-6 d-flex flex-row flex-wrap p-0 m-0 ">
            <div className="col-6 d-flex p-0 m-0">
              <img
                ...
                alt="my-profile"
                width="80%"
                className="rounded-circle bg-success p-0 m-auto"
        ...
        <div className="container w-100 row m-0 p-0 mb-2 justify-content-evenly mx-auto mt-auto">
          <div className="col-3 p-0 text-center d-flex flex-column">
            <div className="text-center h6 m-0">last Game</div>
          ...
          <div className="vr col-1 p-0 mx-1 my-2 border border-2"></div>
          <div className="col-4 p-0 text-center d-flex flex-column">
            <div className="text-center h6 m-0">Last Score</div>
